                                        ...
                                        @foreach($stageGroup['tasks'] as $task)
                                            <div class="group relative overflow-hidden rounded-lg bg-amber-950/20 shadow-sm backdrop-blur-sm transition-all hover:bg-amber-950/30"
                                                ...
                                                <div x-show="expandedTasks[{{ $task->id }}]" x-collapse class="px-3 pl-5 pb-3">
                                                    ...
                                                    <div class="flex flex-wrap gap-2 mt-3 pt-3 border-t border-amber-500/20">
                                                        @php
                                            ...
                                            <div class="group relative overflow-hidden rounded-lg bg-sky-950/20 shadow-sm backdrop-blur-sm transition-all hover:bg-sky-950/30"
                                                ...
                                                <div class="p-3 pl-5 cursor-pointer"
                                                    ...
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <h6 class="text-sm font-medium text-sky-50 flex-1">
                                                            {{ $task->name }}
                                                        </h6>
                                                        <span class="rounded px-1.5 py-0.5 text-xs font-medium bg-sky-500/20 text-sky-300 ring-1 ring-sky-500/30">
                                                            Active
                                                        </span>
                                                    </div>
                                                ...
                                                <div x-show="expandedTasks[{{ $task->id }}]" x-collapse class="px-3 pl-5 pb-3">
                                                    ...
                                                    <!-- Botões de Ação (só aparecem quando expandido) -->
                                                    <div class="flex flex-wrap gap-2 mt-3 pt-3 border-t border-sky-500/20">
                                                        @php
                                                        ...
                                                        <div class="w-px h-6 bg-sky-500/30 self-center"></div>
                                            ...
                                            <div class="group relative overflow-hidden rounded-lg bg-orange-950/20 shadow-sm backdrop-blur-sm transition-all hover:bg-orange-950/30"
                                                ...
                                                <div class="p-3 pl-5 cursor-pointer"
                                                    ...
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <h6 class="text-sm font-medium text-orange-50 flex-1">
                                                            {{ $task->name }}
                                                        </h6>
                                                        <span class="rounded px-1.5 py-0.5 text-xs font-medium bg-yellow-500/20 text-yellow-300 ring-1 ring-yellow-500/30">
                                                            Paused
                                                        </span>
                                                    </div>
                                                ...
                                                <div x-show="expandedTasks[{{ $task->id }}]" x-collapse class="px-3 pl-5 pb-3">
                                                    ...
                                                    <!-- Botões de Ação (só aparecem quando expandido) -->
                                                    <div class="flex flex-wrap gap-2 mt-3 pt-3 border-t border-orange-500/20">
                                                        @php
                                                            $notesCount = $task->notes()->count();
                                                            $attachmentsCount = $task->attachments()->count();
                                                        @endphp
                                                        ...
                                                        <div class="w-px h-6 bg-orange-500/30 self-center"></div>
