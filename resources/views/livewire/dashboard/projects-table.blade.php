<div class="flex w-full flex-col gap-3">
    <div class="flex items-center justify-between gap-4">
        <div>
            <h2 class="text-lg font-semibold text-neutral-900 dark:text-neutral-100">Projetos</h2>
            <p class="text-sm text-neutral-600 dark:text-neutral-400">Clique em “Ver” para abrir o gerenciamento.</p>
        </div>
        <a
