    ...
    <div class="flex-1 overflow-y-auto p-6">
        @forelse($groupedTasks as $projectIndex => $projectGroup)
            ...
            <div class="mb-6 last:mb-0" x-data="{ projectOpen: true }">
                <button @click="projectOpen = !projectOpen" class="mb-3 flex w-full items-center gap-3 border-b border-amber-500/20 pb-3 text-left transition-colors hover:border-amber-500/30">
                ...
                @foreach($projectGroup['stages'] as $stageGroup)
                    ...
                    <div class="mb-4 ml-6" x-data="{ stageOpen: true }">
                        <button @click="stageOpen = !stageOpen" class="mb-3 flex w-full items-center gap-2 text-left transition-colors hover:text-amber-200">
                                ...
                                <div class="group relative overflow-hidden rounded-lg bg-amber-950/20 shadow-sm backdrop-blur-sm transition-all hover:bg-amber-950/30">
                                    ...
                                    <div class="p-4 pl-6">
                                        ...
                                        <div class="flex items-center justify-between gap-4">
                                            ...
                                            <button wire:click="startTask({{ $task->id }})" class="rounded-lg bg-amber-500 px-4 py-2 text-sm font-semibold text-neutral-900 transition-all hover:bg-amber-400 active:scale-95">
                                                Start Task
                                            </button>
                                        </div>
                                    </div>
